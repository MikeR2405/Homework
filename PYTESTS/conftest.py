...
def chrome_options():
    ...
    options.binary_location = r'C:\Program Files\Google\Chrome\Application\chrome.exe'  # Местоположение Chrome
...
def web_browser(request):
    driver_path = r'C:\Users\SONY\Desktop\Study\tests\chrome64\chromedriver.exe'
